...
export const supabase = hasValidSupabaseConfig ? createClient(
  supabaseUrl,
  supabaseAnonKey,
...
export const getMockData = {
  ...
  places_with_visit: (prefecture_id: number) => {
    ...
    return [
      { id: prefecture_id * 100 + 1, name: `${prefectureName}の主要駅`, visited: false, prefecture_id },
      { id: prefecture_id * 100 + 2, name: `${prefectureName}の有名寺院`, visited: true, prefecture_id },
      { id: prefecture_id * 100 + 3, name: `${prefectureName}の観光地`, visited: false, prefecture_id },
      { id: prefecture_id * 100 + 4, name: `${prefectureName}の公園`, visited: true, prefecture_id },
      { id: prefecture_id * 100 + 5, name: `${prefectureName}の博物館`, visited: false, prefecture_id },
      { id: prefecture_id * 100 + 6, name: `${prefectureName}の城跡`, visited: true, prefecture_id },
      { id: prefecture_id * 100 + 7, name: `${prefectureName}の温泉`, visited: false, prefecture_id },
      { id: prefecture_id * 100 + 8, name: `${prefectureName}の展望台`, visited: false, prefecture_id },
    ];
  }
};
